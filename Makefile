...
SOURCES = \
	__init__.py \
	gpi_import.py gpi_import_dialog.py

PLUGINNAME = gpi_import

PY_FILES = \
	__init__.py \
	gpi_import.py gpi_import_dialog.py

UI_FILES = gpi_import_dialog_base.ui
...
QGISDIR=C:\Users\Gerd\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
